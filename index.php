...
<body>
    ...
    <div class="hero-container">
        ...
        <div class="form-container">
            ...
            <form class="form-cont" action="">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                    <input type="text" value="" class="grapRe mdl-textfield__input" id="tb_experience" readonly required>
    ...
    <div class="new-world-container">
        ...
        <div class="new-world-desc-cont">
            <div class="new-world-desc grapRe fs18 gris66">
            ...
            <div class="new-world-desc grapRe gris70">
    ...
    <div class="el-certificado-container">
        ...
        <div class="el-certificado-cont">
            <div class="el-certificado-beneficios grapRe fs18 negro23">
    ...
    <div class="profesor-container">
        ...
        <div class="profesor-cont">
            <div class="profesor-desc">
                <div class="profesor-desc-cont">
                    ...
                    <div class="profesor-data">
                        ...
                        <div class="grapRe fs16 negro4D">Investigadora y profesora titular IESE Business School</div>
                    </div>
                </div>
                <hr>
            ...
            <div class="profesor-media desktop">
                <iframe width="560" height="350" src="https://www.youtube.com/embed/ebSCONiLUlk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="profesor-media movil">
                <iframe width="360" height="350" src="https://www.youtube.com/embed/ebSCONiLUlk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    ...
    <div class="rankings-container">
        ...
        <div class="ranking-cont">
            <img src="assets/img/png/Ranking-FT-First.png" alt="First">
            <img src="assets/img/png/Ranking-FT-Second.png" alt="Second">
            <img src="assets/img/png/Ranking-FT-Thir.png" alt="Thir">
        </div>
    </div>
    ...
    <div class="con-certificado-container">
        <div class="con-certificado-title grapBo fs32 negro19">
            ...
            <div class="con-certificado-cont">
                <div class="con-certificado-beneficios">

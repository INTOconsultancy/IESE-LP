...
<body>
    ...
    <div class="hero-container">
        <div class="hero-title">
            ...
            <div class="hero-title-time">
                ...
                <div class="desc movil grapRe fs16 negro19">6-7 HORAS POR SEMANA</div>
                <div class="desc desktop grapRe fs16 negro19">6-7 HORAS POR SEMANA</div>
                <div class="desc grapBo fs16 negro19">COSTO: $ 1,950 USD</div>
            </div>
        </div>
        <div class="hero-img">
            <img class="desktop" src="assets/img/jpg/Group-mov.jpg" alt="Joven & Movil">
            <img class="movil" src="assets/img/jpg/Group-desk.jpg" alt="Joven & Movil">
        </div>
        <div class="form-container" id="form">
            ...
            <form class="form-cont" action="">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="grapRe mdl-textfield__input" type="text" id="tb_name">
                    <label class="grapRe mdl-textfield__label" for="tb_name">Nombre(s)</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="grapRe mdl-textfield__input" type="text" id="tb_surname">
                    <label class="grapRe mdl-textfield__label" for="tb_surname">Apellido(s)</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="grapRe mdl-textfield__input" type="email" id="tb_email">
                    <label class="grapRe mdl-textfield__label" for="tb_email">Email</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                    <input type="text" value="" class="grapRe mdl-textfield__input" id="tb_pais" readonly required>
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="grapRe mdl-textfield__input" type="tel" id="tb_number">
                    <label class="grapRe mdl-textfield__label" for="tb_number">Número de celular</label>
                </div>
    ...
    <div class="new-world-container">
        <div class="new-world-title grapBo fs32 negro19">
        ...
        <div class="new-world-subtitle grapRe fs20 gris70">
            ...
            tener los últimos “juguetes” tecnológicos si no se cuenta con una
            cultura organizacional capaz de integrarlos a tu metodología de trabajo
            y convertirlos en activos de negocio.
        </div>
        <hr>
        <div class="new-world-desc-cont">
            <div class="new-world-desc grapRe fs18 gris66" data-aos="fade-right" data-aos-offset="50" data-aos-delay="100"
                data-aos-duration="500" data-aos-easing="ease-in-out">
                Se necesita, a nivel individual y
                organizacional, de un <i>digital
                    mindset</i>: <span class="grapBo">una “mentalidad digital”
                    que, como una llave maestra, abra
                    las puertas para acceder a todo
                    nuestro potencial.</span>
            </div>
            <div class="new-world-desc grapRe gris70" data-aos="fade-right" data-aos-offset="50" data-aos-delay="200"
                data-aos-duration="500" data-aos-easing="ease-in-out">
                <span class="grapBo">Descubre las claves para desarrollar esta forma de
                    pensamiento de la mano de Sandra Sieber, experta
                    en cambios digitales y cultura organizacional.</span>
                <br>
                <br>
                Aprende a redimensionar oportunidades, mitigar
                conflictos y construir puentes hacia el futuro
                mediante simulaciones y casos reales que te
                permitirán liderar equipos con un enfoque innovador.
            </div>
        </div>
        <div class="new-world-dates-container">
            <div class="new-world-date-cont" data-aos="fade-right" data-aos-offset="50" data-aos-delay="100"
                ...
                <p class="grapBo fs44 rojoFF">
                    En el 2020
                </p>
                <p class="grapBo fs20 negro3D">
            ...
            <div class="new-world-date-cont" data-aos="fade-right" data-aos-offset="50" data-aos-delay="200"
                data-aos-duration="400" data-aos-easing="ease-in-out">
                <p class="grapBo fs44 rojoFF">
                    Para 2021
                </p>
    ...
    <div class="profesor-container">
        <div class="profesor-title grapBo fs32 negro19">
            Profesorado
        </div>
            ...
            <div class="profesor-desc">
                <div class="profesor-desc-cont">
                    <div class="profesor-img">
                        <img src="assets/img/jpg/Sandra-Sieber.jpg" alt="Dra. Sandra Sieber">
                    </div>
                    <div class="profesor-data">
                        <div class="grapRe fs24 negro19">Dra. Sandra Sieber</div>
                        <div class="grapBo fs16 negro4D">Investigadora y profesora titular</div>
                        <div class="grapRe fs16 negro4D">IESE Business School</div>
                    </div>
                </div>
                <hr>
                <div class="profesor-description grapRe fs14 negro46">
                    Doctora en Management por la IESE Business
                    School en Navarra, Sandra es experta en
                    cambios digitales y cultura organizacional. Es
                    decir, en cómo es que los cambios digitales
                    alteran los modelos de negocio de las
                    organizaciones y éstas últimas se adaptan a
                    dichos cambios para replantear su propuesta de
                    valor. Su trabajo en este campo abarca desde las
                    industrias mediática y del entretenimiento, hasta
                    de telecomunicaciones, bancaria, minorista y automotriz.
                    <br>
                    <br>
                    Académica destacada de IESE, colaboró en la
                    elaboración del libro La Economía Digital: ¡No es
                    la tecnología, es el modelo de negocio,
                    estúpido!, y ha realizado consultoría para
                    empresas multinacionales como Oracle, BBVA, La
                    Caixa, Banco Santander, Telefónica, Vodafone,
                    Komatsu, Olympus, Boston Scientific y Desigual.
                    También asesora con regularidad a startups,
                    incubadoras y fondos de inversión en temas de
                    modelo de negocio y diseño tecnológico.
                </div>
            </div>
            <div class="profesor-media desktop">
                <iframe width="560" height="350" src="https://www.youtube.com/embed/ebSCONiLUlk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
            <div class="profesor-media movil">
                <iframe width="360" height="350" src="https://www.youtube.com/embed/ebSCONiLUlk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
        </div>
    </div>
    ...
    <div class="con-certificado-container">
        <div class="con-certificado-title grapBo fs32 negro19">
            ...
            <div class="con-certificado-cont">
                <div class="con-certificado-beneficios" data-aos="zoom-out-right" data-aos-offset="50" data-aos-delay="100"
                    ...
                    <div class="con-certificado-beneficios-description grapRe fs16 negro19">
                        Emplear las dimensiones del Mindset
                        Digital para determinar cómo la
                        digitalización está afectando a tu
                        sector, industria y negocio.
                    </div>
                </div>
                <div class="con-certificado-beneficios" data-aos="zoom-out-left" data-aos-offset="50" data-aos-delay="200"
                    ...
                    <div class="con-certificado-beneficios-description grapRe fs16 negro19">
                        Incorporar metodologías y procesos
                        ágiles e iterativos que contribuyan a la
                        transformación de tu cultura
                        organizacional.
                    </div>
                </div>
                <div class="con-certificado-beneficios" data-aos="zoom-out-right" data-aos-offset="50" data-aos-delay="300"
                    ...
                    <div class="con-certificado-beneficios-description grapRe fs16 negro19">
                        ...
                        necesarias para replantear propuestas de
                        valor y ejecutar una visión de
                        futuro.
                    </div>
                </div>
                <div class="con-certificado-beneficios" data-aos="zoom-out-left" data-aos-offset="50" data-aos-delay="400"
                    ...
                    <div class="con-certificado-beneficios-description grapRe fs16 negro19">
                        Identificar las cualidades, prácticas y
                        enfoques que hacen a un líder con
                        mentalidad digital.
                    </div>
                </div>
            </div>
            ...
            <ul class="collapsible">
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 1</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 2</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 3</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 4</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 5</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 6</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 7</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 8</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 9</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                ...
                <li class="active modulo-cont">
                    <div class="collapsible-header grapRe fs16">
                        <div class="No rosaFB">Módulo 10</div>
                        <div class="module-title negro23">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                        <div class="collapsible-header-img"></div>
                    </div>
                    <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
    ...
    <div class="beneficios-container">
        ...
        <div class="beneficios-cont">
            <div class="beneficio" data-aos="fade-right" data-aos-offset="50" data-aos-delay="100" data-aos-duration="500"
            ...
            <div class="beneficio" data-aos="fade-right" data-aos-offset="50" data-aos-delay="200" data-aos-duration="500"
                data-aos-easing="ease-in-out">
                <div class="beneficio-img">
            ...
            <div class="beneficio" data-aos="fade-right" data-aos-offset="50" data-aos-delay="300" data-aos-duration="500"
                data-aos-easing="ease-in-out">
                <div class="beneficio-img">
            ...
            <div class="beneficio" data-aos="fade-right" data-aos-offset="50" data-aos-delay="400" data-aos-duration="500"
                data-aos-easing="ease-in-out">
                <div class="beneficio-img">
    ...
    <div class="como-funciona-container">
        ...
        <div class="como-funciona-cont">
            <div class="como-funciona-paso" data-aos="fade-right" data-aos-offset="50" data-aos-delay="100"
                data-aos-duration="500" data-aos-easing="ease-in-out">
            ...
            <div class="como-funciona-paso" data-aos="fade-right" data-aos-offset="50" data-aos-delay="200"
                data-aos-duration="500" data-aos-easing="ease-in-out">
            ...
            <div class="como-funciona-paso" data-aos="fade-right" data-aos-offset="50" data-aos-delay="300"
                data-aos-duration="500" data-aos-easing="ease-in-out">
            ...
            <div class="como-funciona-paso" data-aos="fade-right" data-aos-offset="50" data-aos-delay="400"
                data-aos-duration="500" data-aos-easing="ease-in-out">
